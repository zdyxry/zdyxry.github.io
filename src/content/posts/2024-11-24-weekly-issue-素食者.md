---
title: Weekly Issue-《素食者》
date: "2024-11-24T00:00:00.000Z"
slug: "Weekly-Issue-素食者"
tags:
  - Weekly
description:
---
...
[Docker 命令行小技巧：runlike | 卡瓦邦噶！](https://www.kawabangga.com/posts/6722)

> `docker inspect <container-name> | runlike --stdin` ，就会生成这个容器的 `docker run` 命令。
...
[不会泄露源代码的 AI 编程助手](https://mp.weixin.qq.com/s/Zkb-3BnZ68Qc6MMMgVnUHg)

使用 vscode, continue, Qwen 2.5-Coder-32 B-Instruct , Hyperbolic 来达到 Cursor 效果。也可以考虑直接使用 openrouter API。

---

[The Tragedy of Running an Old Node Project - Abdisalan Mohamud](https://abdisalan.com/posts/tragedy-running-old-node-project)

我的个人博客之前是使用 Hexo 搭建的，配置好 Github Action 之后有一阵子没管它，后面想调整一下，发现本地跑不起来，尝试了很多方式去修复，最后放弃了换成了 Hugo。

---

[They all use it - by Thorsten Ball - Register Spill](https://registerspill.thorstenball.com/p/they-all-use-it)
...
[平衡的跷跷板——风险和收益 · 新钱](https://money.otakusaikou.com/2024/11/17/risk-and-return/)
...
日本的 `黑公司` 以及评判标准。国内有这样的公开统计么，几年前流行的腾讯文档黑名单好像差不多。

---

[我已不再执着于十七岁爱的人](https://yufan.me/posts/i-will-never-regret-loving-you)
...
[There Are Only Three Mindsets: Which Are You? — midwesternish](https://www.midwesternish.com/blog/the-three-mindsets)
...
[Private School Labeler on Bluesky](https://simonwillison.net/2024/Nov/22/private-school-labeler-on-bluesky)
...
* 播客主打的是陪伴，信息密度是低的，不能因为某些播客有一些知识，就去花很多时间听播客，没必要。
* 盒马的山东富士苹果，打了腊，远远不如甘肃的苹果好吃。
* > 既然有退路，就不要选退路，安全感 max ；一旦选了退路，你是不是就没有退路了，绝望 max 。
* 买了香薰，还别说，屋子里有点味道的感觉还不错
* 虽然自己前几天说在上海看不到秋天，看不到落叶，但是现在想一想，在这么冷的天还能看到绿色，好像也是挺不错的
* 看到 Google 因为 Chrome 违反反垄断法，我不理解为什么，同事说我站在 Google 的角度思考是优绩主义
* 每次写字楼的紧急消防演习，我们从不参加，静静的坐在工位上。如果有一天，真的发生了火灾，我们一定一脸懵逼。
* 作为厌恶风险的人，玩赌徒游戏，总是输
* “屁股决定脑袋“这句话真精妙，出自《红楼梦》