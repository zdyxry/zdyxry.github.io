---
title: Weekly Issue-灰色的内衣
date: "2025-08-10T00:00:00.000Z"
slug: "Weekly-Issue-灰色的内衣"
tags:
  - Weekly
description:
---
...
[从「没有对手」到「一天崩溃好几次」｜对谈 Zilliz 创始人 / CEO 星爵](https://archive.is/bm6hz)
...
[第二次简单尝试了一下用 AV1 编码视频，效果依然非常不错 - 陪她去流浪](https://blog.twofei.com/1817/)
...
[Added AGENT.md and links for other LLMs. by cheftako · Pull Request #133386 · kubernetes/kubernetes · GitHub](https://github.com/kubernetes/kubernetes/pull/133386)
...
> Rather than falling as expected, the [cost of some of the latest AI models has risen](https://techcrunch.com/2025/07/07/cursor-apologizes-for-unclear-pricing-changes-that-upset-users/), as they use more time and computational resources to handle complicated, multistep tasks.
...
[OpenFreeMap survived 100,000 requests per second](https://blog.hyperknot.com/p/openfreemap-survived-100000-requests)
...
[Constitution of the United States Website has removed sections! : r/law](https://www.reddit.com/r/law/comments/1mj3ttx/constitution_of_the_united_states_website_has/)
...
[Breakneck: China's Quest to Engineer the Future | Dan Wang](https://danwang.co/breakneck/)

> The simplest idea I present is that China is an _engineering state_, which brings a sledgehammer to problems both physical and social, in contrast with America’s _lawyerly society_, which brings a gavel to block almost everything, good and bad.


---
[月刊（第31期）：基于 Claude 的阅读流 - Airing 的博客](https://blog.ursb.me/posts/weekly-31/)
...
这篇文章写的很好，其中关于 AI 和阅读的看法非常认同。虽然现在已经有很多 AI 插件了，但是这些 AI 插件更多的是关注一个结果，可以短时间生成一份及格的“新闻”，我称之为“新闻”而不是“总结”，“新闻”对我来说是无关紧要的，阅读后的感受不是。AI 生成的内容和直接阅读所感受到的东西差别非常大。我日常会先记录自己的想法，然后把自己的想法让 AI 去找漏洞、偏见、刻板，让 AI 去 Roast 。是之前这里看到的方法： [How I Use AI: Meet My Promptly Hired Model Intern | Armin Ronacher's Thoughts and Writings](https://lucumr.pocoo.org/2025/1/30/how-i-ai/)。

关于阅读过程中所使用的工具可能不重要， Reader 中的 Highlight 功能确实是我需要的。

---

[别做草包族](https://www.seemswrong.com/bie-zuo-cao-bao-zu/)

> 与此同时，我们也常常忽略科学评估的重要性，在评估模型的过程中，我们会挑选对我们有利的指标。我们自我欺骗，营造虚假的繁荣，看起来欣欣向荣。实际上，我们的模型没有得到任何提升，我们也没有走到正确的路上。飞机不会降落下来，我们的模型还是原地踏步。

---

[西点军校半日游 - David Feng个人网站](https://davidfeng.us/zh-cn/2025-07-24-west-point/)
