...
date: "2022-11-13T15:50:00.000Z"
slug: "Weekly-Issue-2022-11-13"
tags:
  - Weekly
...
49分38秒开始，[PDM](/mentions/pdm) 作者讲解 PEP582 及 PDM 实现。
...
最近在了解 [Python](/mentions/python) 包管理相关的内容，网上的大部分信息都是转载或者重复的，直接阅读官方文档或 Pypi参与者(如 [Bernát Gábor](https://bernat.tech/)， [Frost Ming](https://frostming.com/blog/)) 的博客是更好的选择。

---

[Blazing fast CI with MicroVMs](https://blog.alexellis.io/blazing-fast-ci-with-microvms/)   
使用 [MicroVM](/mentions/microvm) 来运行 [github](/mentions/github) actions。主要解决了直接使用 [docker](/mentions/docker)和 [kubernetes](/mentions/kubernetes) 面临的资源隔离问题。也许 [virtink](/mentions/virtink) 可以很好的解决这个场景？
...
[Last9](/mentions/last9) 为了让大家信息公开透明，尽量在 channel 里讨论并形成文档，限制 DM 只保留2天。
...
[写作](/posts/写作)带来的价值，平时浪费的时间很可能是写作产出没有价值的所耗费时间的很多倍。   
...
扎克伯格给 [Meta](/mentions/meta) 员工的信，财源 13% (11000人），降本增效。   
这能说明人们的[社交](/posts/社交)文化被[Tiktok](/mentions/tiktok) 这种洞悉人性的产品给打败了么？   
