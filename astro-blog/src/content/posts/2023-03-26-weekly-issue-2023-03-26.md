...
如何识别 [github](/mentions/github)中的含有虚假star 的项目。

---

[由一个子网掩码配置错误所想到的 | 卡瓦邦噶！](https://www.kawabangga.com/posts/4960)

[子网掩码](/posts/子网掩码)错误配置可能出现的现象。在机房中倒是经常会遇到类似的配置错误的环境。
...
积极拥抱[GPT](/mentions/gpt)，使用工具让生活工作更美好啊。现在确实如果遇到问题，通常会去问问[GPT](/mentions/gpt) 的想法。
