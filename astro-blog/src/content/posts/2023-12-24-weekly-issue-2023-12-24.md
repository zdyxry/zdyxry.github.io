...
[Fly.io](/mentions/flyio) 使用 [k3s](/mentions/k3s) 配合 [Virtual kubelet](/mentions/virtual-kubelet) 构建自己的 [kubernetes](/mentions/kubernetes) 平台，最小组件：CoreDNS，SQLite，Virtual kubelet，将 virtual kubelet 相关接口实现为自己的 Fly machine API 。

---

[Flask 已死，FastAPI 永生 | 李辉](https://greyli.com/flask-fastapi-2023/)

非常佩服[Grey Li](/mentions/grey-li)，面对这种明显是标题党的文档，还会有理有据的去回应，去证明。框架的选型是多方面的，对于文章中提到的 [FastAPI](/mentions/fastapi) 的问题，我会本能的避开。
