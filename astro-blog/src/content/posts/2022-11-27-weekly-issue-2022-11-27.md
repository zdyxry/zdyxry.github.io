...
使用[Debian](/mentions/debian) 配合 [Clash](/mentions/clash) 搭建旁路由。

---

[Will Twitter Fail?](https://matt-rickard.com/will-twitter-fail)    
[Twitter](/mentions/twitter) 会失败么？会因为什么原因失败？感觉在系统不上线新功能的前提下，不会发生宕机。
...
[vmware](/mentions/vmware) [VXRail](/mentions/vxrail) 的故事，从零到一。
