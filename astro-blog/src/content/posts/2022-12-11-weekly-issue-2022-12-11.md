...
[systemd](/mentions/systemd) shutdown 与[dracut-shutdown](/mentions/dracut-shutdown) 的调用关系。

---

[我 EKS 内的 Pod 怎么连不上某个 EC2 了？奇怪的 Docker Compose 桥接网络 Debug 记](https://nova.moe/debug-eks-ec2-connection-problem/)    
想到了公司最近内部新添加了网段是 172.16，也跟 [docker](/mentions/docker) 是重叠的。
...
[HDD](/mentions/hdd) 40 年时间容量从 20MB 到 20TB。
...
[ChatGPT](/mentions/chatgpt) 的一些体验感受。
