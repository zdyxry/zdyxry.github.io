...
[yunji](/mentions/yunji) 同学写的使用[TailScale](/mentions/tailscale) 异地搭建 [k3s](/mentions/k3s) 集群指南，[TailScale](/mentions/tailscale) 真的是好用（在打洞成功的前提下）。
...
[weaveworks](/mentions/weaveworks) CEO 发文，确认停止运营。主要原因是销售增长不稳定，导致现金流紧张，并购也失败了。
