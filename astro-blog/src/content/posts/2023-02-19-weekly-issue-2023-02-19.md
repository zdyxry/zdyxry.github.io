...
date: "2023-02-19T11:00:00.000Z"
slug: "Weekly-Issue-2023-02-19"
tags:
  - Weekly
...
计划基于[Fedora](/mentions/fedora)[coreos](/mentions/coreos) 的发行版，依托于 [ostree](/mentions/ostree) 的 [NativeContainer](/mentions/nativecontainer) 能力，可以很方便的使用 [Container](/mentions/container)来构建自己的 Desktop。

---

[FOSDEM 2023 - blkhash - fast disk image checksums](https://fosdem.org/2023/schedule/event/vai_blkhash_fast_disk/)

用来计算[image](/mentions/image) checksum 的工具，比 [SHA](/mentions/sha) 更快，支持 format 探测等。

---

[https://newsletter.pragmaticengineer.com/p/real-world-eng-8](https://newsletter.pragmaticengineer.com/p/real-world-eng-8)

[Khan](/mentions/khan) 将内部服务从 [Python](/mentions/python) 迁移至 [Golang](/mentions/golang)的过程和思考，根本需求是[Python2](/mentions/python2) 的问题，100 人规模的开发团队，共花费 3.5 年时间完成重写。
...
[Dashboard](/mentions/dashboard) 配置问题。（我们内部产品在出现问题时，大家的关注点完全不同，想要查看 Dashboard 获取有用的信息通常需要自己去从零创建图表。。

---

[Some Useful Patterns for Go's os/exec | DoltHub Blog](https://www.dolthub.com/blog/2022-11-28-go-os-exec-patterns/)

使用 [Golang](/mentions/golang)调用[os/exec](/mentions/osexec)的示例，配合 [Shell](/mentions/shell) 使用必备。

---

[I Think AI Would Kill my Wife | Armin Ronacher's Thoughts and Writings](https://lucumr.pocoo.org/2023/2/17/the-killing-ai/)

对于[Bing](/mentions/bing)[ChatGPT](/mentions/chatgpt)的思考，随着用户越来越多，最近流传的聊天记录有点超过了我的想象。
...
如何个人体验[AI](/mentions/ai) 生成照片，推荐使用[Vultr](/mentions/vultr) 的服务。关键点是如何选择合适的 prompt，文中最后提到通过 [ChatGPT](/mentions/chatgpt)来生成关键词让我没想到。
