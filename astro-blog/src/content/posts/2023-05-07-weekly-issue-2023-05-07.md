...
[Golang](/mentions/golang) 项目的[Makefile](/mentions/makefile) 模板，包含常用的 tidy、lint、test、build。
可以用 [Just](/mentions/just) 和[Task](/mentions/task) 来替代，配合阅读： [Taskfile vs Justfile :: Thanh's Islet](https://nguyenhuythanh.com/posts/taskfile-vs-justfile/)

---

[Electron：厌恶，理解与成为 | pengx17](https://pengx17.vercel.app/posts/becoming-electron-fan)

[AFFiNE](/mentions/affine)放弃了使用[Tauri](/mentions/tauri) ，重新使用了[Electron](/mentions/electron) 。提到了一些 [Tauri](/mentions/tauri)的问题：
...
合理的使用 [CloudFlare](/mentions/cloudflare) 1.1.1.1 和 iCloud 代理来保护隐私。
