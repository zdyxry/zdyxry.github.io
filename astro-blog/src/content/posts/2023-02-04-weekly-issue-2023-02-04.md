...
date: "2023-02-04T11:00:00.000Z"
slug: "Weekly-Issue-2023-02-04"
tags:
  - Weekly
description: 平平无奇的一周。
---
...
[Lens](/mentions/lens) 删除了部分功能引发了大家对其所有权的担忧，官方在推 Desktop 版本。

---

[Linux Load Averages: Solving the Mystery](https://www.brendangregg.com/blog/2017-08-08/linux-load-averages.html)

[Linux](/mentions/linux)[负载](/posts/负载) 解释说明，其中关于`TASK_UNINTERRUPTIBLE` 的历史进行了调查，文章末尾提供了 [性能检查列表](https://www.brendangregg.com/USEmethod/use-linux.html)
...
[hashicorp](/mentions/hashicorp) 开源的基于 [Google Workspace](/mentions/google-workspace) 的文档管理系统。

---

[iPotato | Fly.io 初体验之博客搬家](https://ipotato.me/article/74)

把[Python](/mentions/python) 博客放到[[[Fly.io](http://fly.io/)]] 上运行。提到了 [[[Fly.io](http://fly.io/)]]的招聘流程很有趣。    
...
[hashicorp](/mentions/hashicorp) CTO 针对社区部分提问进行回复，包含了开源社区，个人管理和公司管理。
...
[iCloud](/mentions/icloud) 家庭共享可以跨区。
...
[心理账户](/posts/心理账户)：塞勒认为，每个人都有心理账户，通过该心理账户来进行各种各样的经济[决策](https://zh.m.wikipedia.org/wiki/%E5%86%B3%E7%AD%96)。通过心理账户，可以解释人的不理性经济决策。
