...
date: "2022-08-28T02:00:00.000Z"
slug: "Weekly-Issue-2022-08-28"
tags:
  - Weekly
...
关于 [Steam Deck](/mentions/steam-deck) OS 的介绍，底层是 [Arch](/mentions/arch) Linux，采用的是 A/B 升级方式，应用采用 [Flatpak](/mentions/flatpak) 方式进行安装升级(保证安全性)。现在关于这种 OS 比较轻，应用采用容器化的模式应该是很成熟了。
...
关于 [kubernetes](/mentions/kubernetes) 的 [Readiness](/mentions/readiness) 和 [Liveness](/mentions/liveness) 最佳实践。
...
有时候在公有云使用 [kubernetes](/mentions/kubernetes) 服务是一个更好的选择，但是这个前提是有人帮你维护 [kubernetes](/mentions/kubernetes)，如果是私有环境，维护应该还是一个大问题。
