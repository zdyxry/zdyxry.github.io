...
date: "2022-11-20T15:50:00.000Z"
slug: "Weekly-Issue-2022-11-20"
tags:
  - Weekly
...
`GoGo Protobuf` 停止维护(很久)了，很多 [protobuf](/mentions/protobuf) 的示例项目和生产项目都是使用这个。
...
从中心化/去中心化，[Mastodon](/mentions/mastodon) 协议和托管者的法律风险角度，讨论 [Mastodon](/mentions/mastodon) 替代 [Twitter](/mentions/twitter) 的可能性。
...
[Sapling](/mentions/sapling) 一个与 [git](/mentions/git) 兼容的 client。看上去配合[reviewstack](/mentions/reviewstack) 可以解决 [github](/mentions/github) review 困难的问题。
...
[CloudFlare](/mentions/cloudflare) [Workers](/mentions/workers) 配合 [R2](/mentions/r2)的具体应用。(感觉可以参考下折腾折腾)。

---

[Introducing Tailscale Funnel · Tailscale](https://tailscale.com/blog/introducing-tailscale-funnel/)   
[TailScale](/mentions/tailscale) 类似于 [CloudFlare](/mentions/cloudflare) [Tunnel](/mentions/tunnel) 的产品。后者是真的方便好用，如果 [TailScale](/mentions/tailscale) 支持自定义域名的话可以考虑都使用 [TailScale](/mentions/tailscale)。
...
[warp](/mentions/warp) 介绍如何在[terminal](/mentions/terminal) 中实现类似 IDE 的效果。
普通终端可以使用`Ctrl + x + e` 来使用 [vim](/mentions/vim) 输入命令，也足够使用了。

---

[I was told ~1200 RPCs independently by several engineers at Twitter](https://twitter.com/elonmusk/status/1592176202873085952)   
[马斯克](/posts/马斯克)提到 [Twitter](/mentions/twitter) 时间线会发起 1200 个 RPC，引发了关于[微服务](/posts/微服务)的讨论：
...
[Lyft](/mentions/lyft) 如何进行自动化安全漏洞管理。
